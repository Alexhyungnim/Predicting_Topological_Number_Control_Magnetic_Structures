...
#hyperparameters
ALPHA, BETA = 0.0, 1.0  # Hamiltonian, Regularization
euler_values = np.arange(-3.0, 3.25, 0.25)
fixed_euler_value = 1.0
item = fixed_euler_value
EXJ, DMN, HEXTZ, KZ = 0.0, 0.0, 0.0, 0.0
train_image = 2  #shape_dict = {0:"circle", 1:"square", 2:"triangle", 3:"inv_circle", 4:"square_donut", 5:"dice"}
EPOCHS = 99
BATCH_SIZE = 1
MODNUM = 25
# data loading
